...
import AdsterraBanner160x600 from './ads/AdsterraBanner160x600';
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 sm:p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="w-full flex justify-center gap-4 relative z-10">
                {/* Left Banner - Visible on XL screens */}
                <div className="hidden xl:block w-[160px] sticky top-20 h-fit">
                ...
                {/* Right Banner - Visible on XL screens */}
                <div className="hidden xl:block w-[160px] sticky top-20 h-fit">
                    <AdsterraBanner160x600 />
                </div>
            </div>
